...
var ClientsService = /** @class */ (function () {
    ...
    ClientsService.prototype.complete = function (id) {
    ...
    ClientsService.prototype.undo = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            var item;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    ClientsService.prototype.dataBaseRemove = function (id) {
